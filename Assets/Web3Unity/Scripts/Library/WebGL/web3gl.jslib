mergeInto(LibraryManager.library, {
  ...
  WebRequestAccountConnect: function () {
    window.web3gl.chooseWallet();
  },
  ...
  WaitingFinishLogin: function () {
    var bufferSize = lengthBytesUTF8(window.web3gl.signWaitingFish) + 1;
    var buffer = _malloc(bufferSize);
    stringToUTF8(window.web3gl.signWaitingFish, buffer, bufferSize);
    return buffer;
  },
