...
[Serializable]
    public class AuthenticationKitView : MonoBehaviour
    {
        ...
        {
            Debug.Log("Tuan check AuthenticationKitState:" + authenticationKitState.ToString());
            switch (authenticationKitState)
            {
                ...
                case AuthenticationKitState.WalletSigned:
                    Debug.Log("Tuan check AuthenticationKitState.WalletSigned");
                    // No UI changes here
                    SetActiveUIAllParts(false);
                    _statusText.text = "Signing With Your Game";
                    _statusText.gameObject.active = true;
                    break;
                case AuthenticationKitState.MoralisLoggingIn:
                    Debug.Log("Tuan check AuthenticationKitState.MoralisLoggingIn");
                    // No UI changes here
                    break;
                case AuthenticationKitState.MoralisLoggedIn:
                    Debug.Log("Tuan check AuthenticationKitState.MoralisLoggedIn");
